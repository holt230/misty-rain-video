...
.liquid-search-input { display: block; width: 100%; min-height: 48px; padding: 10px 48px 10px 43px; border: 1px solid rgb(255 255 255 / .92); border-radius: 24px; outline: none; color: var(--text-primary); background: rgb(105 130 180 / .06); box-shadow: inset 0 1px 3px rgb(55 79 122 / .05); font-size: 16px; transition: background .2s, box-shadow .2s; }
.liquid-search-input:focus { background: rgb(255 255 255 / .78); box-shadow: 0 0 0 3px var(--liquid-accent-subtle); }
...
.liquid-btn { width: 100%; min-height: 46px; padding: 10px 16px; border: 0; border-radius: 23px; color: #fff; background: linear-gradient(160deg, #4a80e7, #2c60cf); box-shadow: 0 5px 14px var(--liquid-accent-glow), inset 0 1px rgb(255 255 255 / .35); font-size: .86rem; font-weight: 650; }
.liquid-btn:hover:not(:disabled) { background: var(--liquid-accent-hover); }
.trailing-unit { display: flex; flex-shrink: 0; }
.account-capsule-btn { display: flex; align-items: center; gap: 9px; min-height: 46px; padding: 4px 14px 4px 4px; border: var(--glass-border); border-radius: 25px; color: var(--text-secondary); background: rgb(255 255 255 / .58); box-shadow: var(--glass-highlight-inner); }
